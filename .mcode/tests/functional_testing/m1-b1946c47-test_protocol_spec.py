...
Generated at: 2026-03-08T09:15:52.562286+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid standard email address prints username and domain",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with subdomain prints correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with plus addressing in username",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with dots in username",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with purely numeric username",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with hyphen in domain",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Email piped via echo command is processed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_pipe_input_no_trailing_newline",
        "category": "PIPE_INPUT",
        "description": "Piped input without trailing newline (EOF) is handled correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_boundary_missing_at_sign",
        "category": "BOUNDARY",
        "description": "Input without @ character prints error message",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "invalidemail",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input prints error message after trimming",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "   \t  ",
    ...
    {
        "name": "test_boundary_leading_trailing_spaces",
        "category": "BOUNDARY",
        "description": "Email with leading and trailing whitespace is trimmed and processed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  user@domain.com  ",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with multiple @ splits at first @, remaining @ stays in domain",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Very long but valid email address is processed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with special characters in username is processed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        ...
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  user_name-test.val+tag\nYour domain is:  example.com\n"
    },
    {
        "name": "test_boundary_newline_in_input",
        "category": "BOUNDARY",
        "description": "Input with trailing newline character is trimmed and processed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@domain.com\n",
