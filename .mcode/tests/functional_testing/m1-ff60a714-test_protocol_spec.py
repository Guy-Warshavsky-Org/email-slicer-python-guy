...
Generated at: 2026-03-04T14:02:44.222423+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty input (no '@') produces the invalid email error message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "",
    ...
    },
    {
        ...
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
    ...
    },
    {
        ...
        "stdin": "test@test.com",
        "expected_exit_code": 0,
        "expected_stdout": "Your domain is:  test.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
