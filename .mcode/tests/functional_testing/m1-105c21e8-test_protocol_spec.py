...
Generated at: 2026-03-18T11:38:19.585129+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email address produces correct username and domain output",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email address shows domain in output",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Program displays the email prompt before reading input",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with subdomain in domain part is handled correctly",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    {
        "name": "test_invalid_email_no_at_symbol",
        "category": "BOUNDARY",
        "description": "Email without @ symbol shows invalid message",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at the very start produces empty username",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at the very end produces empty domain",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with multiple @ splits on the first one only",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
        ],
        "stdin": "user@name@domain.com",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  user\nYour domain is:  name@domain.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty stdin (EOF) causes input() to raise EOFError, crashing with exit code 1",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Input of only whitespace is treated as empty / invalid",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
    ...
    },
    {
        ...
        "stdin": "hello@world.org",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  hello",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Piping an invalid email via stdin shows error message",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
        ],
        "stdin": "no-at-sign-here",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter a valid Email Id.",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Very long email address is handled without errors",
        "command": "python",
        "subcommand": "",
        "args": [
            "emailSlicer.py"
