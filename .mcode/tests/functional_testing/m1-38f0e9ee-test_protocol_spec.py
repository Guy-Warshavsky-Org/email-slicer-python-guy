...
Generated at: 2026-03-19T16:34:25.479988+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Standard email is split into correct username and domain",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Standard email produces correct domain output",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "avimax37@gmail.com",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Different valid email is split correctly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_happy_path_different_email_domain",
        "category": "HAPPY_PATH",
        "description": "Different valid email produces correct domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@example.org",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "The prompt message is printed to stdout before reading input",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "test@test.com",
    ...
    {
        "name": "test_boundary_no_at_symbol",
        "category": "BOUNDARY",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty input (no @ symbol) prints error message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with multiple @ symbols splits at the first @, rest goes to domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@sub@domain.com",
        "expected_exit_code": 0,
        "expected_stdout": "Your domain is:  sub@domain.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        "name": "test_boundary_multiple_at_username",
        "category": "BOUNDARY",
        "description": "Email with multiple @ symbols extracts correct username before first @",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@sub@domain.com",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "@ at the start of the string yields empty username and correct domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@domain.com",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "@ at the end of the string yields correct username and empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Input consisting of only @ yields empty username and empty domain but is considered valid",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@",
    ...
    {
        "name": "test_pipe_input_whitespace_trimming",
        "category": "PIPE_INPUT",
        "description": "Leading and trailing whitespace is trimmed from piped input before processing",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  avimax37@gmail.com  ",
