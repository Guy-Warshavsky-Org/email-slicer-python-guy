...
Generated at: 2026-03-18T18:49:33.905562+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with a different domain is correctly parsed",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
        "stdin": "john.doe@company.co.uk\n",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  john.doe\nYour domain is:  company.co.uk",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at the very start yields empty username",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
        "stdin": "@domain.com\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at the very end yields empty domain",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
        "stdin": "user@\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input is trimmed to empty string, shows invalid message",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
        "stdin": "   \n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace around a valid email is trimmed before parsing",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
        "stdin": "  avimax37@gmail.com  \n",
    ...
    {
        "name": "test_pipe_input_crlf_line_ending",
        "category": "PIPE_INPUT",
        "description": "Input with Windows-style CRLF line ending is handled correctly",
        "command": "python",
        "subcommand": "emailSlicer.py",
        "args": [],
