...
Generated at: 2026-03-25T10:24:03.337089+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email is split into username and domain",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with subdomain is split correctly",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "alice@mail.example.co.uk\n",
        "expected_exit_code": 0,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with multiple @ splits on first occurrence, domain contains remaining @",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_happy_path_multiple_at_domain",
        "category": "HAPPY_PATH",
        "description": "Email with multiple @ splits on first occurrence \u2014 verify domain portion",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@sub@example.com\n",
        "expected_exit_code": 0,
        "expected_stdout": "Your domain is:  sub@example.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Verify the prompt text is printed before reading input",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with numeric username is handled correctly",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with dots in username is handled correctly",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with plus addressing is handled correctly",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty input (just newline) prints error message",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Input of just @ splits into empty username and empty domain",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "@\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "@ at start of input gives empty username",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "@example.com\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "@ at end of input gives empty domain",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input is treated as empty after trimming",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "   \n",
    ...
    {
        "name": "test_boundary_very_long_email",
        "category": "BOUNDARY",
        "description": "Very long email address is handled without error",
        "command": "emailslicer",
        "subcommand": "",
        "args": [],
        "stdin": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com\n",
        "expected_exit_code": 0,
        "expected_stdout": "Your domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
