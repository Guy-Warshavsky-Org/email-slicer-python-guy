...
Generated at: 2026-03-04T14:52:26.729675+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        "name": "test_happy_path_basic_email",
        "category": "HAPPY_PATH",
        "description": "Valid email is split into username and domain (README example: avimax37@gmail.com)",
    ...
    {
        "name": "test_happy_path_different_email",
        "category": "HAPPY_PATH",
        "description": "Valid email with a different username and domain is correctly split",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "john.doe@example.org\n",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  john.doe\nYour domain is:  example.org",
        "expected_stderr": null,
        "timeout_seconds": 10,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with subdomain in domain part is correctly split",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Program displays the prompt 'Please enter your Email Id:' before reading input",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "test@test.com\n",
    ...
    {
        "name": "test_invalid_email_plain_text",
        "category": "INVALID_ARGS",
        "description": "Plain text string without '@' is rejected with error message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_boundary_multiple_at_symbols",
        "category": "BOUNDARY",
        "description": "Multiple '@' symbols: split on the first '@', rest goes to domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Leading and trailing whitespace is trimmed before processing",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_boundary_tabs_and_spaces",
        "category": "BOUNDARY",
        "description": "Tabs and mixed whitespace around the email are trimmed",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\t  user@example.com\t \n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty input (no '@') produces invalid email message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input is trimmed to empty, producing invalid email message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "   \n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Input of just '@' is valid (empty username, empty domain)",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@\n",
    ...
    {
        "name": "test_boundary_at_start",
        "category": "BOUNDARY",
        "description": "'@' at start of input produces empty username and full domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@domain.com\n",
    ...
    {
        "name": "test_boundary_at_end",
        "category": "BOUNDARY",
        "description": "'@' at end of input produces full username and empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Special characters (dots, hyphens, plus) in username are preserved",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user.name+tag-test@example.com\n",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  user.name+tag-test\nYour domain is:  example.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  user.name+tag-test\nYour domain is:  example.com\n"
    },
    {
        "name": "test_boundary_exact_username_message",
        "category": "BOUNDARY",
        "description": "Verify exact message format including double space: 'Your username is:  avimax37'",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "avimax37@gmail.com\n",
    ...
    {
        "name": "test_boundary_exact_domain_message",
        "category": "BOUNDARY",
        "description": "Verify exact message format including double space: 'Your domain is:  gmail.com'",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "avimax37@gmail.com\n",
    ...
    {
        "name": "test_boundary_exact_invalid_message",
        "category": "BOUNDARY",
        "description": "Verify exact error message: 'Please enter a valid Email Id.' (with period)",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "nope\n",
    ...
    },
    {
        ...
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  piped\nYour domain is:  stdin.io",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  piped\nYour domain is:  stdin.io\n"
    },
    {
    ...
    {
        "name": "test_pipe_whitespace_trimmed",
        "category": "PIPE_INPUT",
        "description": "Email with surrounding whitespace piped via stdin is trimmed correctly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  piped@stdin.io  \n",
