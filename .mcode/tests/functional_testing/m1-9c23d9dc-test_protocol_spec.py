...
Generated at: 2026-03-23T19:39:52.312783+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    },
    {
        ...
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  alice\nYour domain is:  mail.example.co.uk",
        "expected_stderr": null,
        "timeout_seconds": 10,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with dots in username part is parsed correctly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with plus addressing is parsed correctly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with multiple @ splits on the first @ only (matching Python index behavior)",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "The prompt message is printed before reading input",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty stdin causes EOFError in Python input()",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "",
        ...
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\n",
        "actual_stderr": "Traceback (most recent call last):\n  File \"/Users/guywarshavsky/.local/share/modelcode/_work/703e156a-0850-4f2b-a723-c4bba822defd_email-slicer-python-guy/emailSlicer.py\", line 2, in <module>\n    email = input().strip()\n            ^^^^^^^\nEOFError: EOF when reading a line\n"
    },
    {
    ...
    {
        "name": "test_boundary_at_domain_only",
        "category": "BOUNDARY",
        "description": "Input with @ but no username gives empty username",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@domain.com",
    ...
    {
        "name": "test_boundary_username_at_only",
        "category": "BOUNDARY",
        "description": "Input with @ but no domain gives empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@",
    ...
    {
        "name": "test_boundary_whitespace_input",
        "category": "BOUNDARY",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with leading/trailing whitespace is trimmed before parsing",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  user@example.com  ",
