...
Generated at: 2026-03-04T13:48:27.193100+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email 'avimax37@gmail.com' (README example) is split into username and domain with exact output parity",
        ...
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  avimax37\nYour domain is:  gmail.com\n"
    },
    {
        "name": "test_happy_path_subdomain_email",
        "category": "HAPPY_PATH",
        "description": "Valid email with subdomain is correctly split at the first '@'",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "alice@mail.example.org",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  alice\nYour domain is:  mail.example.org",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  alice\nYour domain is:  mail.example.org\n"
    },
    {
        "name": "test_happy_path_plus_addressing",
        "category": "HAPPY_PATH",
        "description": "Valid email with plus addressing (user+tag@domain) is handled correctly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user+tag@example.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  user+tag\nYour domain is:  example.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  user+tag\nYour domain is:  example.com\n"
    },
    {
        ...
        "description": "Input without '@' produces the invalid email error message",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "invalidemail",
    ...
    },
    {
        ...
        "category": "INVALID_ARGS",
        "description": "Plain text string without '@' is rejected as invalid",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "hello world",
    ...
    {
        "name": "test_multiple_at_symbols",
        "category": "HAPPY_PATH",
        "description": "Email with multiple '@' symbols splits on the first '@' per Python index() semantics",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@sub@example.com",
        "expected_exit_code": 0,
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Leading and trailing whitespace is trimmed before processing, matching Python strip()",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_whitespace_tabs_and_spaces",
        "category": "PIPE_INPUT",
        "description": "Tabs and spaces around input are trimmed",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\t  bob@test.io\t  ",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  bob\nYour domain is:  test.io",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  bob\nYour domain is:  test.io\n"
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty stdin causes EOFError in Python input(), script exits with code 1",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "",
    ...
    {
        "name": "test_boundary_at_only",
        "category": "BOUNDARY",
        "description": "Input of just '@' produces empty username and empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@",
    ...
    {
        "name": "test_boundary_at_at_start",
        "category": "BOUNDARY",
        "description": "'@' at the start of input produces empty username and full domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@domain.com",
    ...
    {
        "name": "test_boundary_at_at_end",
        "category": "BOUNDARY",
        "description": "'@' at the end of input produces full username and empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Very long email address is handled without truncation or error",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com\n"
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Special characters (dots, hyphens, underscores) in the username are preserved",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "first.last-name_123@example.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  first.last-name_123\nYour domain is:  example.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  first.last-name_123\nYour domain is:  example.com\n"
    },
    {
        "name": "test_exact_message_username_label",
        "category": "HAPPY_PATH",
        "description": "Verify exact username label text including double space before value",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "test@test.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  test\nYour domain is:  test.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  test\nYour domain is:  test.com\n"
    },
    {
        "name": "test_exact_message_domain_label",
        "category": "HAPPY_PATH",
        "description": "Verify exact domain label text including double space before value",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "test@test.com",
    ...
    {
        "name": "test_exact_message_invalid_error",
        "category": "HAPPY_PATH",
        "description": "Verify exact invalid email error message text with period at end",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "nope",
    ...
    {
        "name": "test_exact_message_prompt",
        "category": "HAPPY_PATH",
        "description": "Verify the prompt text is printed exactly as 'Please enter your Email Id:'",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "x@y.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  x\nYour domain is:  y.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  x\nYour domain is:  y.com\n"
    }
