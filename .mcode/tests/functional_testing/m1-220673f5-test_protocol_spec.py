...
Generated at: 2026-03-05T11:53:01.873790+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with plus addressing in username is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Valid email with dots in username is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "first.last@company.org",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  first.last\nYour domain is:  company.org",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  first.last\nYour domain is:  company.org\n"
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with multiple '@' splits on the first '@' only",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with all-numeric username is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with hyphens in domain is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "admin@my-company.io",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  admin\nYour domain is:  my-company.io",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  admin\nYour domain is:  my-company.io\n"
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Piped stdin with valid email is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Piped stdin with invalid email shows error message",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "noemail",
    ...
    {
        "name": "test_pipe_input_whitespace_trimmed",
        "category": "PIPE_INPUT",
        "description": "Piped stdin with surrounding whitespace is trimmed before parsing",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  spaced@domain.com  ",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  spaced\nYour domain is:  domain.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  spaced\nYour domain is:  domain.com\n"
    },
    {
        "name": "test_pipe_input_trailing_newline",
        "category": "PIPE_INPUT",
        "description": "Piped stdin with trailing newline is handled correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "description": "Input with no '@' symbol is rejected as invalid",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "not-an-email",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input is rejected as invalid after trimming",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "   ",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Minimal valid email with single-char username and domain",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "a@b",
    ...
    },
    {
        ...
        "subcommand": "",
        "args": [],
        "stdin": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa@bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com\n"
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with special characters in local part is parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user.name+tag-sort@example.com",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  user.name+tag-sort\nYour domain is:  example.com",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  user.name+tag-sort\nYour domain is:  example.com\n"
    },
    {
        "name": "test_boundary_tabs_in_whitespace",
        "category": "BOUNDARY",
        "description": "Input with tab characters in surrounding whitespace is trimmed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\tuser@domain.com\t",
    ...
    {
        "name": "test_boundary_multiple_at_three",
        "category": "BOUNDARY",
        "description": "Email with three '@' symbols splits on the first one",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "a@b@c@d",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  a\nYour domain is:  b@c@d",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  a\nYour domain is:  b@c@d\n"
    }
