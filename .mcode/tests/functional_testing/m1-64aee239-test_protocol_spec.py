...
Generated at: 2026-03-17T14:47:54.541745+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        ...
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "subcommand": "",
        "args": [],
        "stdin": "john.doe@mail.example.com",
        "expected_exit_code": 0,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with plus addressing is correctly parsed",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "user+tag@example.org",
        "expected_exit_code": 0,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with multiple @ signs splits at the first @ (matching Python behavior)",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "user@name@example.com",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  user\nYour domain is:  name@example.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with numeric username is correctly parsed",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "12345@example.com",
        "expected_exit_code": 0,
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Program displays the input prompt before reading email",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_invalid_email_no_at_sign",
        "category": "INVALID_ARGS",
        "description": "Email without @ character prints error message",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "invalidemail",
    ...
    },
    {
        ...
        "category": "INVALID_ARGS",
        "description": "Plain text without @ prints error message",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at start produces empty username",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "@example.com",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with @ at end produces empty domain",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "user@",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Leading and trailing whitespace is trimmed from input before parsing",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Email with special characters in username is parsed without validation",
        "command": "python3 emailSlicer.py",
        "subcommand": "",
        "args": [],
        "stdin": "user.name+filter@example.com",
        "expected_exit_code": 0,
        "expected_stdout": "Your username is:  user.name+filter\nYour domain is:  example.com",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
