...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Verify the username part is correctly extracted and printed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Verify the domain part is correctly extracted and printed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "alice@gmail.com\n",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Verify the prompt text is displayed before reading input",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "test@test.com\n",
    ...
    },
    {
        ...
        "category": "HAPPY_PATH",
        "description": "Email with dots in local part is correctly parsed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "first.last@example.com\n",
        "expected_exit_code": 0,
        "expected_stdout": "first.last",
        "expected_stderr": null,
        "timeout_seconds": 10
    },
    {
        ...
        "description": "Email without @ symbol should show error message",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "invalid-email\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Empty input should show error message",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Whitespace-only input should be trimmed to empty and show error",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "   \n",
    ...
    },
    {
        ...
        "category": "BOUNDARY",
        "description": "Leading and trailing whitespace around a valid email should be trimmed and parsed correctly",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "  user@example.com  \n",
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Valid email piped via stdin is correctly parsed",
        "command": "email-slicer",
        "subcommand": "",
        "args": [],
