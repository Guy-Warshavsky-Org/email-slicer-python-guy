...
Generated at: 2026-03-04T10:59:41.578142+00:00
...
TEST_CASES = resolve_env_placeholders(json.loads(r'''[
    {
        "name": "test_valid_email_standard",
        "category": "HAPPY_PATH",
        "description": "Standard valid email is split into username and domain",
    ...
    {
        "name": "test_valid_email_subdomain",
        "category": "HAPPY_PATH",
    ...
    {
        "name": "test_valid_email_plus_addressing",
        "category": "HAPPY_PATH",
        "description": "Valid email with plus addressing in the username",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_valid_email_dots_in_username",
        "category": "HAPPY_PATH",
        "description": "Valid email with dots in the username part",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Input without '@' character is treated as invalid",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "invalidemail\n",
    ...
    {
        "name": "test_input_with_leading_trailing_spaces",
        "category": "PIPE_INPUT",
        "description": "Leading and trailing whitespace is stripped before processing",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    },
    {
        ...
        "category": "PIPE_INPUT",
        "description": "Multiple '@' characters: split at the first '@', rest goes to domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
    ...
    {
        "name": "test_whitespace_only_input",
        "category": "BOUNDARY",
        "description": "Whitespace-only input is treated as invalid after trimming",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "   \n",
    ...
    {
        "name": "test_at_sign_at_start",
        "category": "BOUNDARY",
        "description": "'@' at the start produces an empty username and full domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@domain.com\n",
    ...
    {
        "name": "test_at_sign_at_end",
        "category": "BOUNDARY",
        "description": "'@' at the end produces a username with empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user@\n",
    ...
    {
        "name": "test_just_at_sign",
        "category": "BOUNDARY",
        "description": "Just '@' produces empty username and empty domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "@\n",
    ...
    },
    {
        ...
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com\n",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\nYour domain is:  bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb.com\n"
    },
    {
        "name": "test_email_with_hyphens",
        "category": "HAPPY_PATH",
        "description": "Email with hyphens in both username and domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "my-name@my-domain.co.uk\n",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  my-name\nYour domain is:  my-domain.co.uk\n",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  my-name\nYour domain is:  my-domain.co.uk\n"
    },
    {
        "name": "test_email_with_numbers",
        "category": "HAPPY_PATH",
        "description": "Email with numbers in username and domain",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "user123@mail456.com\n",
        "expected_exit_code": 0,
        "expected_stdout": "Please enter your Email Id:\nYour username is:  user123\nYour domain is:  mail456.com\n",
        "expected_stderr": null,
        "timeout_seconds": 10,
        "actual_stdout": "Please enter your Email Id:\nYour username is:  user123\nYour domain is:  mail456.com\n"
    },
    {
        "name": "test_plain_text_no_special_chars",
        "category": "PIPE_INPUT",
    ...
    {
        "name": "test_input_with_tab_whitespace",
        "category": "BOUNDARY",
        "description": "Input with tab characters as whitespace is trimmed properly",
        "command": "./email-slicer",
        "subcommand": "",
        "args": [],
        "stdin": "\tuser@example.com\t\n",
